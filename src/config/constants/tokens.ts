...
const { MAINNET, TESTNET, KOVAN, MSC } = ChainId
...
export const testnetTokens = {
  ...
  usdc: new Token(
    TESTNET,
    '0x9DbC65c84532f71e6DbB93B6842BF1Fd72109551',
    18,
    'USDC',
    'Binance-Peg USD Coin',
    'https://www.centre.io/usdc',
  ...
  btc: new Token(
    TESTNET,
    '0xAA69B06A14B8E4faa9fDc4404462d291Ca811624',
    18,
    'BTC',
    'Binance BTC',
    'https://bitcoin.org/',
  ...
  cake: new Token(
    TESTNET,
    '0x439e40d9aC13D3CC37Fa2017b46A1987BefD861b',
    18,
    'CAKE',
    'PancakeSwap Token',
    'https://pancakeswap.finance/',
  ...
  busd: new Token(
    TESTNET,
    '0x258651B4691b1Eb09083DDce0596115f1654998B',
    18,
    'BUSD',
    'Binance USD',
    'https://www.paxos.com/busd/',
  ...
  syrup: new Token(
    TESTNET,
    '0x487b02C01c0F6c3c2b30ee345225CB03eB10F198',
    18,
    'SYRUP',
    'SyrupBar Token',
    'https://pancakeswap.finance/',
...
// 42
export const kovannetTokens = {
  wbnb: new Token(
    KOVAN,
    '0x4D6f717032e6030732939c0198C36F94F33E4B72',
    18,
    'WBNB',
    'Wrapped BNB',
    'https://www.binance.com/',
  ...
  usdc: new Token(
    KOVAN,
    '0x1256dBC778E5cBa65E7Ef7F5C9C54A07c4d2dd12',
    18,
    'USDC',
    'Binance-Peg USD Coin',
    'https://www.centre.io/usdc',
  ...
  cake: new Token(
    KOVAN,
    '0x01E670a761ee64cb2FD09d2BdD53d34A36Ec568d',
    18,
    'CAKE',
    'PancakeSwap Token',
    'https://pancakeswap.finance/',
  ...
  syrup: new Token(
    KOVAN,
    '0x5F813997e2261519dbD05356B1F7Bd17fc38A7F8',
    18,
    'SYRUP',
    'SyrupBar Token',
    'https://pancakeswap.finance/',
  ...
  btc: new Token(
    KOVAN,
    '0xe781A0D2C6A83E822FE6F266A505E7a8ec202BDB',
    18,
    'BTC',
    'Binance BTC',
    'https://bitcoin.org/',
...
// 777
export const mscnetTokens = {
  wbnb: new Token(
    MSC,
    '0xfa95376c1469063176Bfe1ee4D6A45CE094b03Ed',
    18,
    'WNEX',
    'Wrapped NEX',
    'https://www.binance.com/',
  ...
  usdc: new Token(
    MSC,
    '0xcA0eE8E8ceF0D5fe6Fa0a6c56beF67faB8D7374F',
    18,
    'USDC',
    'Binance-Peg USD Coin',
    'https://www.centre.io/usdc',
  ...
  busd: new Token(
    MSC,
    '0x93e7523E24BDe43ce93b5970c6fa251c5b1E1aEa',
    18,
    'BUSD',
    'Binance-Peg USD Coin',
    'https://www.centre.io/busd',
  ),
  cake: new Token(
    MSC,
    '0x61ecEa3A1f4f82f4BADe8E072Bb40ffABfB4dE0B',
    18,
    'NU',
    'Binance-Peg USD Coin',
    'https://www.centre.io',
  ...
  syrup: new Token(
    MSC,
    '0x4666eD6B47e0Dc39224116cfDa6b012efa8e691C',
    18,
    'SYRUP',
    'SyrupBar Token',
    'https://pancakeswap.finance/',
  ...
  btc: new Token(
    MSC,
    '0xa313bc005B91e24470ea4F41B87f03e99AF1E044',
    18,
    'BTC',
    'Binance BTC',
    'https://bitcoin.org/',
  ...
  kalm: new Token(
    MSC,
    '0xeEc2eB55FF2a2d5a5E3c9F909D6bB23c6ce8599f',
    18,
    'AAA',
    'AAA Token',
    'https://kalmar.io/',
...
const tokens = (): TokenList => {
  ...
  if (parseInt(chainId, 10) === ChainId.KOVAN) {
    return Object.keys(mainnetTokens).reduce((accum, key) => {
      return { ...accum, [key]: kovannetTokens[key] || mainnetTokens[key] }
    }, {})
  }

  if (parseInt(chainId, 10) === ChainId.MSC) {
    return Object.keys(mainnetTokens).reduce((accum, key) => {
      return { ...accum, [key]: mscnetTokens[key] || mainnetTokens[key] }
    }, {})
  }
