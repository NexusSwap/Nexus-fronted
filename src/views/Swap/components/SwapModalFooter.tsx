    ...
    <>
      <SwapModalFooterContainer>
        <RowBetween align="center">
          <Text fontSize='18px' fontWeight={400} color='#fff'>{t('Price')}</Text>
          <Text
            fontSize='18px' fontWeight={400} color='#fff'
            style={{
        ...
        <RowBetween>
          ...
          <RowFixed>
            ...
            <Text fontSize='18px' fontWeight={400} color='#fff' marginLeft="4px">
              {trade.tradeType === TradeType.EXACT_INPUT
        ...
        <RowBetween>
          <RowFixed>
            <Text fontSize='18px' fontWeight={400} color='#fff'>{t('Price Impact')}</Text>
            <QuestionHelper
        ...
        <RowBetween>
          <RowFixed>
            <Text fontSize='18px' fontWeight={400} color='#fff'>{t('Liquidity Provider Fee')}</Text>
            <QuestionHelper
              text={
                <>
