...
function TradeSummary({ trade, allowedSlippage }: { trade: Trade; allowedSlippage: number }) {
  ...
  return (
    <AutoColumn style={{ padding: '0' }}>
      <RowBetween>
        <RowFixed>
          <Text fontSize="18px" color="textSubtle" style={{lineHeight: 1}} fontWeight={400}>
      ...
      <RowBetween>
        ...
        <Text fontSize="18px" style={{lineHeight: 1}} fontWeight={400}>
    ...
    <AutoColumn gap="0px">
      {trade && (
        <>
          ...
          {showRoute && (
            <>
              <RowBetween style={{ padding: '0', marginBottom: 0 }}>
                <span style={{ display: 'flex', alignItems: 'center' }}>
                  <Text fontSize="18px" color="textSubtle" style={{lineHeight: 1}} >
                    {t('Route')}
                  </Text>
                  <QuestionHelper
