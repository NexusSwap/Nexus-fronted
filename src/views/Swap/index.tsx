...
const ImageBlock = styled.div<{turn: boolean}>`
  transform: rotate(${props => (props.turn ? '0deg' : '180deg')});
  transition: 0.4s;
  width: 64px;
  height: 64px;
  border-radius: 50%;
      ...
      <AppBody background="#191B26">
        ...
        <Wrapper id="swap-page">
          <AutoColumn gap="md">
              ...
              <AutoRow justify={isExpertMode ? 'space-between' : 'center'}>
                <ArrowWrapper
                  ...
                  <ImageBlock turn={turn}>
                    <img
                      src="/images/trade/transaction.svg"
                      alt=""
                      width='100%'
                      height='100%'
                    />
            ...
            {showWrap ? null : (
              <AutoColumn gap="8px" style={{ margin: '12px 0 35px 0' }}>
                {Boolean(trade) && (
